...
objects = Latte/Abs.hs Latte/Lex.hs Latte/Par.hs IDefinition.hs Translator.hs CompilationError.hs VariableEnvironment.hs FCCompiler.hs FCCompilerTypes.hs
compilers = Main.hs
